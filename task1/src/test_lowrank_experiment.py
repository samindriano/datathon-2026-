from run_lowrank_experiment import acceptance_gate
...
def test_lowrank_gate_requires_material_broad_conservative_gain():
    candidates = {
        "stableblend": _summary(36.56, [41.75, 38.41, 29.52], [31.29, 37.06, 41.33], 5.16),
        "lowrankblend": _summary(36.0, [41.1, 37.9, 29.0], [30.9, 36.5, 40.6], 5.0),
    }
    stress = {
    ...
    diagnostics = {
        "lowrankblend_m2_mean_correction_vs_ridge": -0.2,
        "lowrankblend_vs_e013_rms": 0.5,
